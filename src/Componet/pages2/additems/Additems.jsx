...
const Additems = () => {
  ...
  return (
    <div className="bg-[#f3f3f3] w-[100%] mt-[2%]  ">
      <div className=""></div>
        ...
        <form className="" onSubmit={handleSubmit(onSubmit)}>
          ...
          <label className="form-control w-full mx-20">
            ...
            <input
              ...
              className="input input-bordered w-[701px]"
            />
          </label>
            ...
            <div>
              ...
              <label className="form-control ">
                ...
                <select
                  ...
                  className="select select-bordered ml-20 w-[20rem]"
                >
                  <option disabled value={"defolt"}>
                    Category
                  </option>
                  <option>salad</option>
                  <option>pizza</option>
          ...
          <label className="form-control">
            ...
            <textarea
              ...
              className="textarea ml-20 textarea-bordered w-[701px] h-24"
          ...
          <button className="btn  ml-20 w-[180px] bg-gradient-to-r from-[#835D23] to-[#B58130] text-white mt-7 mb-11 text-[20px]">
            {" "}
            Add Item <FontAwesomeIcon icon={faUtensils}></FontAwesomeIcon>
          </button>
        </form>
      </div>
    </div>
