    ...
    <div>
      <div>
        <div className=" mx-[397px]">
          <h1 className="text-[#D99904] text-[20px] font-medium  grid justify-center mt-32 mb-3">
            ---Hurry Up!---
          </h1>
          <div className="border h-[2px] "></div>
          <h1 className="text-[30px] font-medium  grid justify-center mt-4 mb-3">
            MANAGE ALL ITEMS
          </h1>
        ...
        <div className="">
          <div className="">
            <h1 className="text-[32px] font-bold mt-9 ml-16">
              {" "}
          ...
          <tbody className="">
            {menu.map((itam, index) => (
              <tr key={itam._id}>
                ...
                <td>
                  <Link to={`/sidebar/upret/${itam._id}`}>
                    {" "}
                    <button className=" btn btn-ghost btn-xs h-11 bg-green-400 rounded-[7px] w-[3.2rem] mt-4 ml-3">
                      <FontAwesomeIcon
...
{/* HendelDelet */}
                <th>
                  <button
                    ...
                    className="btn btn-ghost btn-xs h-11 bg-red-500 rounded-[7px] w-[3.2rem]"
                  >
                    <FontAwesomeIcon
                      className="h-4 text-white"
                      icon={faTrash}
