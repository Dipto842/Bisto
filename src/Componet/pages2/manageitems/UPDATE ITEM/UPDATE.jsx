          ...
          <div className="mx-12">
            <div className="">
              <label className="form-control w-full ml-14 mb-8 mt-9">
                ...
                <input
                  ...
                  placeholder={name}
                  defaultValue={name}
                  className="input input-bordered w-[775px]   " /> 
              </label>
            </div>
            ...
            <div className="flex gap-16 ml-14">
              <div>
                <label
                  ...
                  className="form-control w-[387.5px] max-w-xs"
                >
                  <div className="label">
              ...
              <div>
                <label className="form-control w-full ">
                  ...
                  <input
                    ...
                    placeholder={price}
                    defaultValue={price}
                    className="input input-bordered w-[387.5px]"
                  />
                </label>
              </div>
            </div>
            ...
            <div className=" mt-14 mr-12 ml-14">
              ...
              <textarea
                ...
                placeholder={recipe}
                defaultValue={recipe}
                className="textarea textarea-bordered textarea-lg  w-[775px] mb-7"
              ></textarea>
            </div>
          </div>
          <div>
